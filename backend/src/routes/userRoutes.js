...
const {createUser,getUser,getUserById,getUserStats}=require('../controllers/user/userController');
...
router.get('/getStats',validateToken,authorizeRoles("guard","admin"),getUserStats);
